 ...
 *   - FAST-FTL (fully-associative sector translation)
 * ========================================= */
...
/* =========================================
 * Data mapping and Fully-Associative Log blocks
 * ========================================= */
...
/*
 * Fully-associative log block:
 *   - One log block can contain pages from multiple LBNs.
 *   - Pages are appended sequentially (write_ptr), as required by NAND.
 *   - Read path must scan ALL log blocks to find the newest version of a given LPN.
 */
typedef struct {
